...
| [196](196-keymap-learn-truth-priority.md) | ADR-195の段階4/6/8を修正し、既知プリセット構成でも内蔵表を審査官にせず学習結果を優先する。陳腐化は失効でなく要再検証とし、フィンガープリントにIME本体バージョンを追加する | 草案rev4（round4判定「骨格は引き続き収束、Blocker0件」。round5は反映確認のみで収束見込み） |
