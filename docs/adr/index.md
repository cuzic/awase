...
| [172](172-tsfnative-blind-rescue-four-system-consolidation.md) | TsfNative ON方向救済4系統(force-on/drift correction/warmup/reassert)の整理方針。round1でissue_open_warrant()配線案を撤回、観測ソース信頼フィルタの共有述語抽出へ再設計 | 起草。opus-adversarial-consult round1反映済み・round2待ち |
