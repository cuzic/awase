...
| [178](178-msi-uninstall-preserve-userdata.md) | MSIアンインストール時のユーザーデータ喪失を自己修復(INSTALLDIR配下backup\へのバックアップ+起動時復元、能力トークンで順序保証)で無害化する。wix/main.wxsは変更しない | 起草中v10(v1〜v9で計15件のBlockerを段階的に解消)・round10レビュー待ち |
...
| [178-opus-review-round1.md](178-opus-review-round1.md)〜[round10.md](178-opus-review-round10.md) | ADR-178 敵対的レビュー記録（Opus round1〜10） | [178](178-msi-uninstall-preserve-userdata.md) |
