...
| [175](175-physical-dbe-key-stuck-direction-recovery.md) | 物理半角/全角キーがOS側で同一方向のVKを繰り返し報告するとshadow-toggleがno-op誤判定し送信自体を試みなくなる問題を修正(BUG-142)。Ctrl+無変換の実機確認で送信経路自体は生きていると確定 | 起草、opus-adversarial-consult未実施 |
