...
| [198](198-persistence-destination-classification.md) | 永続化先の分類(config.toml/cache.toml/学習表JSON)とv2でのcalibrationの扱い | 草案(2026-09-24、opus round1・2反映済み、決定3はユーザー確認待ち) |
