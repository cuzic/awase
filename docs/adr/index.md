...
| [174](174-solo-tap-passthrough-belief-reobservation.md) | 無変換/変換ソロタップの生キーパススルーを維持し、GJI実結果を再観測してbeliefへ反映(BUG-142「IME ON固着」対策)。ADR-173(生キー抑止方式)はユーザーが「巡回機能を潰す・乱暴」と却下し不使用に | 起草中、opus-adversarial-consult未実施 |
