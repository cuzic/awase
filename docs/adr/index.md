...
| [177](177-msi-restart-manager-graceful-shutdown.md) | 常駐中のMSIアップグレードをRestart Manager経由でgraceful shutdown対応する(WM_QUERYENDSESSION/WM_ENDSESSION未処理・RegisterApplicationRestart未使用を修正) | 起草中・opus-adversarial-consult未実施 |
