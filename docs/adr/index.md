...
| [178](178-msi-uninstall-preserve-userdata.md) | MSIアンインストール時のユーザーデータ喪失を自己修復(MSI管理外へのバックアップ+起動時復元)で無害化する。wix/main.wxsは変更しない | 起草中v2(v1のPermanent="yes"案はopus round1でBlocker2件により却下)・レビュー待ち |
