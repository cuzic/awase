...
| [172](172-tsfnative-blind-rescue-four-system-consolidation.md) | TsfNative ON方向救済4系統(force-on/drift correction/warmup/reassert)の整理方針。mozc内部IPC/TSF観測経路の探索は不成立と確認、force-on/drift correctionのBUG-110型衝突が非対称に修正済みと判明しissue_open_warrant()の配線を対象特定 | 起草。opus-adversarial-consult未実施 |
