...
| [178](178-msi-uninstall-preserve-userdata.md) | MSIアンインストール時のユーザーデータ喪失を自己修復(INSTALLDIR配下backup\へのバックアップ+起動時復元)で無害化する。wix/main.wxsは変更しない | 起草中v3(v1のPermanent="yes"はround1でBlocker2件、v2はround2でBlocker3件検出・反映済み)・round3レビュー待ち |
