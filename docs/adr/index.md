...
| [172](172-tsfnative-blind-rescue-four-system-consolidation.md) | TsfNative ON方向救済4系統(force-on/drift correction/warmup/reassert)の整理方針。mozc内部IPC/TSF観測経路の探索は不成立と確認、ADR-157の教訓(調停より発火源修正)を設計原則に採用 | 起草。opus-adversarial-consult未実施 |
