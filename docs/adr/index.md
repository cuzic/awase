...
| [170](170-codesmell-hotspot-decomposition.md) | コードスメル解消: belief reduce()の大きい4分岐をprivateヘルパーへ抽出(決定1のみ実施) | opus-adversarial-consult round1で決定2(runtime/mod.rs重複統合)・決定3(output/mod.rs分割)を事実誤認/テスト破壊のため見送りに縮小、決定1を実施しround2確認待ち |
