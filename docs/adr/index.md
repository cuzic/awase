...
| [178](178-msi-uninstall-preserve-userdata.md) | MSIアンインストール時にユーザーデータ(config.toml/layout/)を残す(対象7コンポーネントにPermanent="yes"追加、ZIP版と対称化) | 起草中・opus-adversarial-consult未実施 |
