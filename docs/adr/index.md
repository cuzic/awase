...
| [178](178-msi-uninstall-preserve-userdata.md) | MSIアンインストール時のユーザーデータ喪失を自己修復(INSTALLDIR配下backup\へのバックアップ+起動時復元、単一関数で順序保証)で無害化する。wix/main.wxsは変更しない | 起草中v5(v1〜v4で計8件のBlockerを段階的に解消)・round5レビュー待ち |
