...
| [172](172-tsfnative-blind-rescue-four-system-consolidation.md) | TsfNative ON方向救済4系統(force-on/drift correction/warmup/reassert)の現状整理。BUG-110衝突は既に解消済みと判明、決定2(force-onゲート変更)は実装せず既知の技術的負債として記録する方針に確定 | opus-adversarial-consult round1〜round3で収束(Blockerゼロ)。決定1・決定2ともコード変更なし |
