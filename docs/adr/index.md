...
| [195](195-keymap-learn-productization.md) | カスタムキーマップ対応のため、IMEキー効果の学習(awase-keymap-learn)を製品化する（設定読取→巡回学習→自己検証→永続化→実行時読込→ADR-176統合） | 草案rev2（round1指摘反映、round2待ち） |
