...
| [197](197-msime-legacy-custom-keymap-runtime-warning.md) | MS-IME「以前のバージョンのMicrosoft IMEを使う」互換モードの詳細キーカスタマイズ競合(旧UI)を、不具合報告添付だけでなく`check_and_warn`と対称な実行時警告にも対応させる | 草案(2026-09-23起票)。opus-adversarial-consultによるレビュー未実施 |
