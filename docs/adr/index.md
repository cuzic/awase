...
| [190](190-msime-immcross-failure-fallback-idempotent-vk-ime-on.md) | Microsoft IMEでImmCrossが失敗したとき、非冪等なVK_KANJIトグルでなく冪等なVK_IME_ON/OFF(MsImeDirect)へフォールバックする(BUG-152) | **ドラフト v2(未実装)**。opus round1反映済み(round2確認待ち)。CI(a8/a9)検証済み、実機・ATOK未 |
