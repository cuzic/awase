...
| [200](200-reinit-must-not-run-during-live-composition.md) | chrome-reinit(VK_IME_OFF→ON)は生きた composition があるとき送らない(StaleConfirm 起因の give-up では reinit しない) | 草案(opus-adversarial-consult 待ち) |
