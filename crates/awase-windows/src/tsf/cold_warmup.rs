...
//!      │    ├─ remaining == 0 かつ requires_settle → F2 再送 + WarmupStarted (GjiProbe)
//!      │    ├─ remaining == 0 かつ !requires_settle → fresh F2 + WarmupStarted (GjiProbe)
//!      │    └─ remaining > 0 → WarmupStarted (GjiProbe, needs_settle_check=true)
