...
impl VkCodeExt for VkCode {
    ...
    fn from_name(name: &str) -> Option<Self> {
        match name {
            ...
            "VK_F13" => Some(VkCode(0x7C)),
            "VK_F14" => Some(VkCode(0x7D)),
            "VK_F15" => Some(VkCode(0x7E)),
            "VK_F16" => Some(VkCode(0x7F)),
            "VK_F17" => Some(VkCode(0x80)),
            "VK_F18" => Some(VkCode(0x81)),
            "VK_F19" => Some(VkCode(0x82)),
            "VK_F20" => Some(VkCode(0x83)),
            "VK_F21" => Some(VkCode(0x84)),
            "VK_F22" => Some(VkCode(0x85)),
            "VK_F23" => Some(VkCode(0x86)),
            "VK_F24" => Some(VkCode(0x87)),
