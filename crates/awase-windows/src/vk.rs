...
pub fn vk_name_to_code(name: &str) -> Option<VkCode> {
    match name {
        ...
        "VK_CONVERT" | "Convert" => Some(VkCode(0x1C)),
        #[allow(clippy::match_same_arms)]
        "VK_NONCONVERT" | "VK_MUHENKAN" | "Nonconvert" => Some(VkCode(0x1D)),
        "VK_KANA" | "Kana" => Some(VkCode(0x15)),
        "VK_KANJI" | "Kanji" => Some(VkCode(0x19)),
        "VK_IME_ON" | "ImeOn" => Some(VkCode(0x16)),
        "VK_IME_OFF" | "ImeOff" => Some(VkCode(0x1A)),
