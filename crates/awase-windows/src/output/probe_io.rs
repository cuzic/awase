...
mod tests {
    ...
    fn tsf_transmit_uses_eager_path_when_nc_not_fired_even_with_deferred_vks() {
        ...
        let actions = vec![ProbeAction::Transmit {
            ...
            observations: ProbeObservations { nc_fired: false, gji_resumed: false, gji_long_idle_probe_nonfired: false },
            romaji: "ki".to_string(),
    ...
    fn gji_resumed_skips_literal_detect_to_prevent_false_positive() {
        ...
        let actions = vec![ProbeAction::Transmit {
            ...
            observations: ProbeObservations { nc_fired: true, gji_resumed: true, gji_long_idle_probe_nonfired: false },
            romaji: "to".to_string(),
            deferred_vks: vec![],
            target: TransmitTarget::Tsf,
        }];
