...
pub struct UnicodeSender<'a>(pub &'a super::Output);
pub struct VkSender<'a>(pub &'a super::Output);
pub struct TsfSender<'a>(pub &'a super::Output);
